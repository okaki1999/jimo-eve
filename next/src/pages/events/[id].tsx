...
const EventDetail: NextPage = () => {
  ...
  const url = process.env.NEXT_PUBLIC_API_BASE_URL + '/events/'
  ...
  const event: EventProps = camelcaseKeys(data)
              ...
              <List sx={{ color: '#6e7b85' }}>
                <ListItem divider>
                  ...
                  >
                    ...
                    <Box>
                      <ListItemText primary={event.user.name} />
                    </Box>
                  </Box>
                </ListItem>
                <ListItem divider>
                ...
                <ListItem>
                  ...
                  >
                    ...
                    <Box>
                      <ListItemText primary={event.updatedAt} />
                    </Box>
                  </Box>
                </ListItem>
              </List>
